...
async function generatePdfExample() {
    ...
    try {
        ...
        */
        ...
        console.log('📄 Step 2: Generating PDF (document_id response)...');
        const doc1 = await client.documents.generate('template-ced17c74-431a-465c-860a-fc3da4cca8ae', {
            data: {
                invoice_number: 'INV-2025-001',
        ...
        */
        ...
        const outputPath = path.join(__dirname, '../output', `invoice-${doc1.document_id}.pdf`);
        ...
        const pdfBuffer = await client.documents.download(doc1.document_id, outputPath);
